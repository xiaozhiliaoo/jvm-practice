package org.lili.examples.oom.case2;
    ...
    public static class FullPermSpace extends Thread {
        ...
        public void run() {
            for (int i = 0; i < 100_000_000; i++) {
                ...
                try {
                    pool.makeClass("org.lili.examples.oom.case1.KeyLessEntry" + i).toClass();
    ...
    public static class FullPermSpace2 extends Thread {
        ...
        public void run() {
            for (int i = 0; i < 100_000_000; i++) {
                ClassPool pool = ClassPool.getDefault();
                try {
                    pool.makeClass("org.lili.examples.oom.case1.LiLi" + i).toClass();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
